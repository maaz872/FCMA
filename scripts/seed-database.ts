...
async function seed() {
  ...
  const workouts = [
    ...
    { title: "Lower Body Blast", slug: "lower-body-blast", sub: "lower-body", diff: "Intermediate", dur: "40 min", goal: "Muscle Gain", video: "https://youtu.be/1V9xGo2gkbY", desc: "Target quads, hamstrings and glutes for a strong lower body.", instructions: ["Squats 4x10","Romanian deadlifts 4x8","Leg press 3x12","Walking lunges 3x12 each leg","Calf raises 4x15","Cool down stretch"] },
    { title: "Core Crusher", slug: "core-crusher", sub: "core", diff: "Beginner", dur: "20 min", goal: "Fat Loss", video: "https://youtu.be/2pLT-olgUJs", desc: "Intense core workout for visible abs.", instructions: ["Plank hold 45 sec","Bicycle crunches 20 reps","Leg raises 15 reps","Russian twists 20 reps","Mountain climbers 20 reps","Rest 30 sec","Repeat 3 rounds"] },
