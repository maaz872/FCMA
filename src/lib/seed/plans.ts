  ...
  trainingDays: [
    {
      label: "Upper",
      exercises: [
        { workoutSlug: "barbell-incline-bench-press-medium-grip", sets: 4, repsLow: 8, repsHigh: 10, restSeconds: 90, weightKg: 30, notes: "Start at ~30 kg and add 2.5 kg/week when you hit the top of the rep range." },
        { workoutSlug: "barbell-curl", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 60, weightKg: 15 },
        { workoutSlug: "hammer-curls", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 60, weightKg: 10 },
    ...
    },
    {
      label: "Lower + Core",
      exercises: [
        { workoutSlug: "barbell-lunge", sets: 4, repsLow: 10, repsHigh: 12, restSeconds: 90, weightKg: 30, notes: "Each leg" },
        { workoutSlug: "barbell-hip-thrust", sets: 4, repsLow: 10, repsHigh: 12, restSeconds: 90, weightKg: 50 },
    ...
    },
    {
      label: "Full Body",
      exercises: [
        { workoutSlug: "barbell-incline-bench-press-medium-grip", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 75, weightKg: 25 },
        { workoutSlug: "barbell-lunge", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 75, weightKg: 25 },
        { workoutSlug: "dumbbell-bicep-curl", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 60, weightKg: 10 },
  ...
  trainingDays: [
    {
      label: "Heavy Arms",
      exercises: [
        { workoutSlug: "barbell-curl", sets: 4, repsLow: 8, repsHigh: 10, restSeconds: 75, weightKg: 20 },
        { workoutSlug: "dumbbell-bicep-curl", sets: 4, repsLow: 10, repsHigh: 12, restSeconds: 60, weightKg: 12 },
        { workoutSlug: "hammer-curls", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 60, weightKg: 12 },
        { workoutSlug: "dumbbell-tricep-extension", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 60, weightKg: 12 },
      ],
    },
    {
      label: "Legs + Core",
    ...
    },
    {
      label: "Push + Triceps",
      exercises: [
        { workoutSlug: "barbell-incline-bench-press-medium-grip", sets: 4, repsLow: 8, repsHigh: 10, restSeconds: 90, weightKg: 35 },
        { workoutSlug: "tricep-dips", sets: 3, repsLow: 8, repsHigh: 12, restSeconds: 75, notes: "Bodyweight — add a belt with weight as you progress." },
        { workoutSlug: "cable-tricep-extension", sets: 3, repsLow: 12, repsHigh: 15, restSeconds: 60, weightKg: 20 },
        { workoutSlug: "hammer-curls", sets: 3, repsLow: 12, repsHigh: 15, restSeconds: 60, weightKg: 10 },
      ],
    },
  ],
  trainingDayMeals: [
  ...
  trainingDays: [
    {
      label: "Strength",
      exercises: [
        { workoutSlug: "barbell-incline-bench-press-medium-grip", sets: 4, repsLow: 5, repsHigh: 8, restSeconds: 120, weightKg: 40 },
        { workoutSlug: "barbell-front-squat", sets: 4, repsLow: 5, repsHigh: 8, restSeconds: 120, weightKg: 50 },
        { workoutSlug: "pull-ups", sets: 4, repsLow: 5, repsHigh: 8, restSeconds: 120, notes: "Bodyweight only — use assistance bands if you can't hit 5 clean reps." },
        { workoutSlug: "3-4-sit-up", sets: 3, repsLow: 12, repsHigh: 15, restSeconds: 45, durationSeconds: 45 },
      ],
    },
    {
      label: "Hypertrophy",
      exercises: [
        { workoutSlug: "dumbbell-incline-bench-press", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 75, weightKg: 16 },
        { workoutSlug: "one-arm-cable-row", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 60, weightKg: 25, notes: "Each side" },
        { workoutSlug: "leg-press", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 90, weightKg: 100 },
        { workoutSlug: "dumbbell-lateral-raise", sets: 3, repsLow: 12, repsHigh: 15, restSeconds: 60, weightKg: 7 },
        { workoutSlug: "dumbbell-bicep-curl", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 60, weightKg: 12 },
      ],
    },
    {
      label: "Compound + Accessories",
      exercises: [
        { workoutSlug: "dumbbell-bench-press", sets: 3, repsLow: 8, repsHigh: 10, restSeconds: 90, weightKg: 18 },
        { workoutSlug: "barbell-shrugs", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 60, weightKg: 60 },
        { workoutSlug: "lying-leg-curl", sets: 3, repsLow: 10, repsHigh: 12, restSeconds: 60, weightKg: 35 },
        { workoutSlug: "cable-face-pull", sets: 3, repsLow: 12, repsHigh: 15, restSeconds: 60, weightKg: 15 },
        { workoutSlug: "3-4-sit-up", sets: 3, repsLow: 15, repsHigh: 20, restSeconds: 45 },
      ],
    },
  ],
